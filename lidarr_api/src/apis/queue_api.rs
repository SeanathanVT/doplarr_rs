...
/// struct for typed errors of method [`api_v1_queue_bulk_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ApiV1QueueBulkDeleteError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`api_v1_queue_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ApiV1QueueGetError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`api_v1_queue_id_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ApiV1QueueIdDeleteError {
    UnknownValue(serde_json::Value),
}

pub async fn api_v1_queue_bulk_delete(
    configuration: &configuration::Configuration,
    remove_from_client: Option<bool>,
    blocklist: Option<bool>,
    skip_redownload: Option<bool>,
    change_category: Option<bool>,
    queue_bulk_resource: Option<models::QueueBulkResource>,
) -> Result<(), Error<ApiV1QueueBulkDeleteError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<ApiV1QueueBulkDeleteError> = serde_json::from_str(&content).ok();
...
pub async fn api_v1_queue_get(
    configuration: &configuration::Configuration,
    page: Option<i32>,
    page_size: Option<i32>,
    sort_key: Option<&str>,
    sort_direction: Option<models::SortDirection>,
    include_unknown_artist_items: Option<bool>,
    include_artist: Option<bool>,
    include_album: Option<bool>,
    artist_ids: Option<Vec<i32>>,
    protocol: Option<models::DownloadProtocol>,
    quality: Option<Vec<i32>>,
) -> Result<models::QueueResourcePagingResource, Error<ApiV1QueueGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ApiV1QueueGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn api_v1_queue_id_delete(
    configuration: &configuration::Configuration,
    id: i32,
    remove_from_client: Option<bool>,
    blocklist: Option<bool>,
    skip_redownload: Option<bool>,
    change_category: Option<bool>,
) -> Result<(), Error<ApiV1QueueIdDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_query_remove_from_client = remove_from_client;
    let p_query_blocklist = blocklist;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ApiV1QueueIdDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
