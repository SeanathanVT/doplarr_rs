...
/// struct for typed errors of method [`feed_v1_calendar_lidarr_ics_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum FeedV1CalendarLidarrIcsGetError {
    UnknownValue(serde_json::Value),
}

pub async fn feed_v1_calendar_lidarr_ics_get(
    configuration: &configuration::Configuration,
    past_days: Option<i32>,
    future_days: Option<i32>,
    tags: Option<&str>,
    unmonitored: Option<bool>,
) -> Result<(), Error<FeedV1CalendarLidarrIcsGetError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<FeedV1CalendarLidarrIcsGetError> = serde_json::from_str(&content).ok();
