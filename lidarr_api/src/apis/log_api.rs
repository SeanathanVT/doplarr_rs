...
pub async fn api_v1_log_get(
    ...
    level: Option<&str>,
) -> Result<models::LogResourcePagingResource, Error<ApiV1LogGetError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ApiV1LogGetError> = serde_json::from_str(&content).ok();
