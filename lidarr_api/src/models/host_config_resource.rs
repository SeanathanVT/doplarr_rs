...
pub struct HostConfigResource {
    ...
    #[serde(
        rename = "proxyBypassLocalAddresses",
        skip_serializing_if = "Option::is_none"
    )]
    pub proxy_bypass_local_addresses: Option<bool>,
    #[serde(
        rename = "certificateValidation",
        skip_serializing_if = "Option::is_none"
    )]
