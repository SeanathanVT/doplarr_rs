...
pub struct NotificationResource {
    ...
    #[serde(
        rename = "supportsOnReleaseImport",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "supportsOnArtistAdd",
        skip_serializing_if = "Option::is_none"
    )]
    pub supports_on_artist_add: Option<bool>,
    #[serde(
        rename = "supportsOnArtistDelete",
        skip_serializing_if = "Option::is_none"
    )]
    pub supports_on_artist_delete: Option<bool>,
    #[serde(
        rename = "supportsOnAlbumDelete",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "supportsOnDownloadFailure",
        skip_serializing_if = "Option::is_none"
    )]
    pub supports_on_download_failure: Option<bool>,
    #[serde(
        rename = "supportsOnImportFailure",
        skip_serializing_if = "Option::is_none"
    )]
    pub supports_on_import_failure: Option<bool>,
    #[serde(
        rename = "supportsOnTrackRetag",
        skip_serializing_if = "Option::is_none"
    )]
