...
pub struct UiConfigResource {
    ...
    #[serde(
        rename = "calendarWeekColumnHeader",
        default,
    ...
    #[serde(
        rename = "enableColorImpairedMode",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "expandAlbumByDefault",
        skip_serializing_if = "Option::is_none"
    )]
    pub expand_album_by_default: Option<bool>,
    #[serde(
        rename = "expandSingleByDefault",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "expandBroadcastByDefault",
        skip_serializing_if = "Option::is_none"
    )]
    pub expand_broadcast_by_default: Option<bool>,
    #[serde(
        rename = "expandOtherByDefault",
        skip_serializing_if = "Option::is_none"
    )]
